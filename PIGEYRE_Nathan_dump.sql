...
CREATE TABLE `messages` (
  `id` int NOT NULL AUTO_INCREMENT,
  `envoyeur` varchar(50) DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `Comptabilite` tinyint(1) DEFAULT '0',
  `Informatique` tinyint(1) DEFAULT '0',
...
-- Dump completed on 2023-12-26 17:22:18
